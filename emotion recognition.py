...
pid=0
count_smile,count_eact,count_be,count_talk=0,0,0,0
...
while True:
        ...
        #y51=0
        #y59=0
        print('count_eact,count_smile,count_be,count_talk',count_eact,count_smile,count_be,count_talk)
        '''if count_eact>3:
        ...
        for rect in rects:
                ...
                for (x, y) in shape:
                        ...
                        ##########
                                ...
                                dist_talk=((x62-x68)**2+(y62-y68)**2)**0.5
                                print('dist-talk',dist_talk)
                                diff_talk=(dist_talk)-dist_talko

                                if diff_talk<0:
                                        diff_talk*=-1

                                print('diff-talk',diff_talk)
                                
                                print('dist-talko',dist_talko)
                                if j==1 or diff_talk>8:
                                        dist_talko=dist_talk
                                        
                                        
                                if diff_talk<6:
                                        dist_talko=(dist_talko+dist_talk)//2
...
#                                y55=y
#
#                                dist_smile1=((x49-x55)**2+(y49-y55)**2)**0.5
#                                print('dist-smile1',dist_smile1)
#                                diff_smile1=(dist_smile1)-dist_smilo
#                                if diff_smile1<0:
#                                        diff_smile1*=-1
#
#                                print('diff-smile1',diff_smile1)
#                                
#                                print('dist-smilo',dist_smilo)
#                                if j==1 or diff_smile>15:
#                                        dist_smilo=dist_smile1
#                                        
#                                        
#                                if diff_smile1<6:
#                                        dist_smilo=(dist_smilo+dist_smile1)//2
#                        
#                        
#                        
#                        ###########
                                ...
                                x52=x
                                y52=y
                                dist_leye=((x34-x52)**2+(y34-y52)**2)**0.5
                        ...
                        if diff_chx<10 and diff_chy<10:
                                ...
                                #################
                                        ...
                                        cv2.putText(frame,'talking', (50, 50),cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 1)
                                        talk=1
                                ###################
        ...
        # show the frame
            ...
            count_talk=count_talk+1
                ...
                #exit()
        #res = "count_eact: " +" smile : "+ "bothe:" +" talk:"q
        import pandas as pd
        df= pd.read_csv("c.csv")
        df.to_csv("c.csv", header=["smile_count", "e_act", "bothe","Talk_count"], index=False)
        row = [count_eact, count_smile, count_be, count_talk]
        with open('/home/rohit/Downloads/New folder/c.csv','a+') as csvFile:
